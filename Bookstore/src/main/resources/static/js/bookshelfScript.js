...
function readMoreBookDescription(id) {
	...
	document.querySelector('#bookAbbrDescription-'+id).style.maxHeight = 'none';
	var currentHeight = document.querySelector('#bookAbbrDescription-'+id).clientHeight;
	document.querySelector('#bookAbbrDescription-'+id).style.maxHeight = '212px';
	
	$('#bookAbbrDescription-'+id).animate({'maxHeight' : currentHeight},200,'linear');

	console.log(document.querySelector('#bookAbbrDescription-'+id).style.maxHeight);
...
function readLessBookDescription(id) {
	...
	$('#bookAbbrDescription-'+id).animate({maxHeight : '212'},200,'linear');
...
$('.a-link-expander').on('click', function() {
